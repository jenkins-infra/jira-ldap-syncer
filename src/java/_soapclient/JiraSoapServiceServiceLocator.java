...
public class JiraSoapServiceServiceLocator extends org.apache.axis.client.Service implements _soapclient.JiraSoapServiceService {
    ...
    private java.lang.String JirasoapserviceV2_address = "http://localhost:8080//rpc/soap/jirasoapservice-v2";
    ...
    public _soapclient.JiraSoapService getJirasoapserviceV2() throws javax.xml.rpc.ServiceException {
    ...
    public _soapclient.JiraSoapService getJirasoapserviceV2(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            _soapclient.JirasoapserviceV2SoapBindingStub _stub = new _soapclient.JirasoapserviceV2SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (_soapclient.JiraSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                _soapclient.JirasoapserviceV2SoapBindingStub _stub = new _soapclient.JirasoapserviceV2SoapBindingStub(new java.net.URL(JirasoapserviceV2_address), this);
                _stub.setPortName(getJirasoapserviceV2WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080//rpc/soap/jirasoapservice-v2", "JiraSoapServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080//rpc/soap/jirasoapservice-v2", "jirasoapservice-v2"));
        }
