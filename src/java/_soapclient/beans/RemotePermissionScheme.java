...
public class RemotePermissionScheme  extends _soapclient.beans.RemoteScheme  implements java.io.Serializable {
    private _soapclient.beans.RemotePermissionMapping[] permissionMappings;
    ...
    public RemotePermissionScheme(
           ...
           _soapclient.beans.RemotePermissionMapping[] permissionMappings) {
        super(
            description,
            id,
            name,
     ...
     */
    public _soapclient.beans.RemotePermissionMapping[] getPermissionMappings() {
        return permissionMappings;
    }
     ...
     */
    public void setPermissionMappings(_soapclient.beans.RemotePermissionMapping[] permissionMappings) {
        this.permissionMappings = permissionMappings;
    }
