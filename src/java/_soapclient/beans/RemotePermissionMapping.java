...
public class RemotePermissionMapping  implements java.io.Serializable {
    private _soapclient.beans.RemotePermission permission;

    private _soapclient.beans.RemoteEntity[] remoteEntities;

    public RemotePermissionMapping() {
    }

    public RemotePermissionMapping(
           _soapclient.beans.RemotePermission permission,
           _soapclient.beans.RemoteEntity[] remoteEntities) {
     ...
     * @return permission
     */
    public _soapclient.beans.RemotePermission getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(_soapclient.beans.RemotePermission permission) {
        this.permission = permission;
    }
     ...
     */
    public _soapclient.beans.RemoteEntity[] getRemoteEntities() {
        return remoteEntities;
    }
     ...
     */
    public void setRemoteEntities(_soapclient.beans.RemoteEntity[] remoteEntities) {
        this.remoteEntities = remoteEntities;
    }
