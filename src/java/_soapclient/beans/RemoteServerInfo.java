...
public class RemoteServerInfo  implements java.io.Serializable {
    ...
    private _soapclient.beans.RemoteTimeInfo serverTime;
    ...
    public RemoteServerInfo(
           ...
           _soapclient.beans.RemoteTimeInfo serverTime,
     ...
     * @return serverTime
     */
    public _soapclient.beans.RemoteTimeInfo getServerTime() {
        return serverTime;
    }
     ...
     * @param serverTime
     */
    public void setServerTime(_soapclient.beans.RemoteTimeInfo serverTime) {
        this.serverTime = serverTime;
    }
